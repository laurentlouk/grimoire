...
Expectation to check: Writes the plan to a file with numbered user stories in the form 'as an [actor] I want [feature] so that [benefit]', the seams and vertical slices ordered smallest first
