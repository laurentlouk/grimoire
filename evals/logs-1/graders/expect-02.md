...
Expectation to check: Filters the run's events for PROJ-12's route and escalate events (reading events/*.jsonl chunks in name order, or events.jsonl on an older run)
