...
Expectation to check: Explores the repositories read-only before proposing anything, including CI commands and any expensive gate with its exact command
