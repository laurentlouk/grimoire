...
Expectation to check: Presents one proposal with a team agent per repository, a grimoire.config.json repos entry with its gate, memory stores, an AGENTS.md roster and the CLAUDE.md lines, and asks for one yes or corrections
