...
Expectation to check: Keeps the existing backend-engineer definition and proposes appending the 'Explore before asking; don't guess' section only if it is missing
