...
Expectation to check: The brief carries the explore-before-asking rule, the `NEEDS_CONTEXT` reminder, and the end states `DONE`, `DONE_WITH_CONCERNS`, `NEEDS_CONTEXT`, `BLOCKED`
